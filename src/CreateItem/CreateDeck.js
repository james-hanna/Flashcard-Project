...
export default function CreateDeck({deck, setDeck, reRender, setReRender,}){
    ...
    return(
      ...
      <form onSubmit={submitHandler} class="container">
          ...
          <label class="row">
              Name:
              <input id="name" type="text" name="name" onChange={changeHandler} value={deckData.name} />
          </label>
          <label class="row">
              Description:
              <textarea id="description" type="textarea" name="description" onChange={changeHandler} value={deckData.description} ></textarea>
          </label>
